...
class Product(models.Model):
    ...
    data = models.TextField(verbose_name="Необходимые данные для покупки", null=True,
                           blank=True)
    datalinktopay = models.TextField(verbose_name="Ссылка на оплату", null=True,
                           blank=True)
    idfrompaylink = models.TextField(verbose_name="id платежа", null=True,
                           blank=True)
...
class Order(models.Model):
    ...
    urltopay = models.TextField(verbose_name="Link to pay", default="", null=True, blank=True)
    payid = models.TextField(verbose_name="Pay id", default="", null=True, blank=True)
    phone = models.CharField(verbose_name="Номер телефона", max_length=15, null=True, blank=True)
    fio = models.CharField(verbose_name="ФИО", max_length=200, null=True, blank=True)
